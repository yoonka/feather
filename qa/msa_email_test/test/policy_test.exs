defmodule MsaEmailTest.PolicyTest do
  ...
  describe "validate_envelope/1" do
    ...
    test "rejects when recipients list is empty" do
      opts = [
        from: "frodo@maxlabmobile.com",
        rcpts: [],
        password: "s3cret!",
    ...
    test "accepts when allowed_from is provided as CSV string (domain match)" do
      opts = [
        from: "frodo@maxlabmobile.com",
    ...
    test "rejects invalid From format in envelope" do
      opts = [
      ...
      dprint("opts", opts)
      assert {:error, :invalid_format} = Policy.validate_envelope(opts)
    end
  end
end
